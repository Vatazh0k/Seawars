...
//namespace Seawars.Aplication.GameLogic
//{
//    public class Field
//    {
...
//        }
//        public Field PutShip(int _cell, int DecksCount, bool Direction)
//        {
//            ResetTimer();
...
//                    _ = Direction is true ?
//                     secondIndex = Indexes.X + i :
//                     firstIndex = Indexes.Y + i;
...
//            return this;
//        }
//        public bool CanAttackCell(int _cell)
//        {
//            var items = _cell.ConvertCellToIndexes();
...
//                _ = Direction is true ?
//                 secondIndex = indexes.X + k :
//                 firstIndex = indexes.Y + k;
